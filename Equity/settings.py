...
UTH_USER_MODEL = 'banking_system.User'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'banking.authentication.BankingTokenAuthentication',  # Custom authentication
    ],
...
MIDDLEWARE = [
    ...
    'django.middleware.csrf.CsrfViewMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'banking.middleware.BankingAuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'banking.middleware.AuditTrailMiddleware',
    'banking.middleware.SecurityEventMiddleware',
    'banking.middleware.TransactionLogMiddleware',
    'banking.middleware.RateLimitMiddleware',
...
TEMPLATES[0]['OPTIONS']['context_processors'] += [
    'banking.context_processors.banking_settings',
    'banking.context_processors.user_accounts',
    'banking.context_processors.notifications_count',
]
